 ...
 */
#define CHECK(msg, fn) { rcl_ret_t temp_rc = fn; if((temp_rc != RCL_RET_OK)){check(msg);}}
 ...
 * @param msg Error message to be printed.
 */
#define SOFT_CHECK(msg, fn) { rcl_ret_t temp_rc = fn; if((temp_rc != RCL_RET_OK)){softCheck(msg);}}
